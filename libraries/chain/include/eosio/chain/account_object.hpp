...
FC_REFLECT(eosio::chain::account_object, (name)(vm_type)(vm_version)(privileged)(contract_host)(last_code_update)(code_version)(creation_date)(code)(abi))
